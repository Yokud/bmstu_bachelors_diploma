...
void AdditionalLightShadows_float(float3 WorldPos, half4 Shadowmask, out float ShadowAtten)
{
#ifdef SHADERGRAPH_PREVIEW
		ShadowAtten = 1;
#else
    ...
    LIGHT_LOOP_BEGIN(pixelLightCount)
		...
		{
			half val = AdditionalLightRealtimeShadow(lightIndex, WorldPos, light.direction);;
